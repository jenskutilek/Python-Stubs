...
class Choice(Asn1Value):
    def __init__(self, name: None | str = None, value: None | str | Asn1Value = None, **kwargs) -> None: ...
...
class Sequence(Asn1Value):
    def __init__(self, value: None | Dict[str, str] | OrderedDict[str, object] = None, default: None | Dict[str, str] = None, **kwargs) -> None: ...
